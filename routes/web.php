...
Route::get('/satu', [SatuController::class, 'DwintaS']);

Route::get('/dua', [DuaController::class, 'DwintaS']);

Route::get('/tiga', [TigaController::class, 'DwintaS']);

Route::get('/empat', [EmpatController::class, 'DwintaS']);

Route::get('/lima', [LimaController::class, 'DwintaS']);

Route::get('/enam', [EnamController::class, 'DwintaS']);

Route::get('/tujuh', [TujuhController::class, 'DwintaS']);

Route::get('/delapan', [DelapanController::class, 'DwintaS']);

Route::get('/sembilan', [SembilanController::class, 'DwintaS']);